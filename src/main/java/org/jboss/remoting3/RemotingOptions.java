...
public final class RemotingOptions {
    ...
    // Increased defaults to 400 as a Contextual is created to act as a per-deployment and too many channels can occur easily.
    // Trying to share the ClientServiceHandler across deployments broke encapsualtion of the Contextuals see REM3-426
    private static final int HARD_CODED_DEFAULT_MAX_INBOUND_CHANNELS = 400;
    private static final int HARD_CODED_DEFAULT_MAX_OUTBOUND_CHANNELS = 400;
