...
/**
 * @param <I> the request object type
 * @author <a href="mailto:david.lloyd@redhat.com">David M. Lloyd</a>
 */
public interface RPCClient<I> {
     ...
     * guarantee.
     * <p/>
     * If the request cannot be sent, some other {@code IOException} will be thrown with the reason, including (but not limit
     ...
     */
    <O> O invoke(RPCRequest<I, O> request) throws IOException, CancellationException;
     ...
     * {@link #invoke(RPCRequest)} method will result.  This condition can be determined by reading the status of
     ...
     * @throws IOException if some other I/O error occurred while sending the request
     */
    <O> IoFuture<O> send(RPCRequest<I, O> request) throws IOException;

    /**
     * A factory for new RPC clients.
     */
    class Factory {
         ...
         * @param marshallingConfiguration the marshalling configuration to use
         * @param <I> the request type
         * @return the new client instance
         */
        public static <I> RPCClient<I> create(Channel channel, MarshallerFactory marshallerFactory, MarshallingConfiguration marshallingConfiguration) {
            return null;
        }
    }
}
